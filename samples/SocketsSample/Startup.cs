...
namespace SocketsSample
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<PersistentConnectionEndPoint>();
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSockets(routes =>
            {
                ...
                routes.MapSignalRV2EndPoint("/foo", builder =>
                {
                    builder.UseEndPoint<PersistentConnectionEndPoint>();
                });

                routes.MapSignalRV2EndPoint("/signalr", builder =>
                {
                    builder.UseEndPoint<SignalRV2EndPoint>();
                });
            });
        }
    }
